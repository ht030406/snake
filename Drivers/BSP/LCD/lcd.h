...
void position(uint16_t x,uint16_t y,uint16_t color);              /*显示一个点*/
void position_body(uint16_t x,uint16_t y,uint16_t color);         /*画蛇身*/  
void position_clear(uint16_t x,uint16_t y);                       /*清除一个点*/
